...
void removeDLPosition(dl_list *dll,long pos);
...
void freeDLNode(dl_list *dll,dl_node *node,int v);
void freeDLList(dl_list *root,int v);
...
void writeDLListToFile(dl_list *dll, dl_node *start, dl_node *end, long num,
                       char *fname);
void writeDLListToStream(dl_list *dll,dl_node *start,dl_node *end,long num,
