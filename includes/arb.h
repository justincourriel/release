...
ARB_API char           *HashFromByteArray(MEM_FILE *,int32_t,int32_t);
...
ARB_API char TestUnitBitArray(bit_array* ba);
...
ARB_API uint64_t DivideUint64By10(uint64_t n);
ARB_API bit_array* IntDivideBitArrayBy10(bit_array* ba1);
ARB_API bit_array* DivideBitArrayBy10(bit_array* ba, uint8_t* remainder);
ARB_API bit_array* DivideBitArrayByPowerOf10(bit_array* ba, uint64_t pow10);
...
ARB_API char* BitArrayToBase10IntegerStringRecursive(bit_array* ba);
ARB_API bit_array** GetPowerOf10BitArrays(uint64_t powmax);
//ARB_API uint64_t DivideBy10(uint64_t n);
...
ARB_API uint64_t TrimLowerZeroBits(bit_array* ba);
...
ARB_API uint64_t CountLeadingZeroBits(uint64_t x);
...
ARB_API bit_array* BitArrayFactorial(bit_array* ba);
ARB_API bit_array* ExponentiateBitArrays(bit_array* ba1, bit_array* ba2);
